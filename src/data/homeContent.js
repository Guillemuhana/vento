...
export const BANNERS = [
  ...
  {
    id: 'desayunos',
    image: '/assets/banners/desayunos.jpg',
    titleKey: 'banner.desayunos.title',
    subtitleKey: 'banner.desayunos.subtitle',
    bg: 'bg-tile-peach',
    to: '/categoria/panaderia',
  },
  {
    id: 'envio-gratis',
    image: '/assets/banners/envio-gratis.jpg',
    titleKey: 'banner.envio-gratis.title',
    subtitleKey: 'banner.envio-gratis.subtitle',
    bg: 'bg-tile-mint',
    to: '/ofertas',
  },
]
