  ...
  return (
    <section className="relative mx-4 mb-7 min-h-[330px] overflow-hidden rounded-2xl bg-ink text-white shadow-card">
      ...
      <div className="relative flex min-h-[330px] flex-col justify-end p-5">
        ...
        <h2 className="mt-1 font-display text-[26px] font-bold leading-tight">{building.name}</h2>
        ...
        <p className="mt-2 max-w-md text-[13px] leading-snug text-white/85">{t('buildingPromo.text')}</p>
        <p className="mt-2 text-[12px] text-white/70">{building.address}</p>
